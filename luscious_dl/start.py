...
from multiprocessing.dummy import freeze_support as fs_dummy
...
def normalize_args(args: Namespace) -> Namespace:
    ...
    if args.rm_origin_dir and not args.gen_pdf and not args.gen_cbz:
        logger.warn(
            "You're passing --rm-origin-dir flag without any pdf or cbz generation. This would delete the album "
            "after download")
